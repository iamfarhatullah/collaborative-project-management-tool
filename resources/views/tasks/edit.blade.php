    ...
    <form action="{{ route('tasks.update', $task->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="title" class="form-field" value="{{ $task->title }}" placeholder="Enter task title" required>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="date" name="start_date" class="form-field" value="{{ $task->start_date }}" required>
            </div>
            <div class="col-md-4">
                <label for="end_date" class="form-label">End Date</label>
                <input type="date" name="end_date" class="form-field" value="{{ $task->end_date }}" required>
            </div>
            <div class="col-md-4">
